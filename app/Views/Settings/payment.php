...
<?= form_open('/settings/' . $type . '/new', ['class' => 'row g-3']) ?>
            ...
            <tr style="vertical-align:middle;">
                ...
                <td>
                    <div class="btn-toolbar" role="group">
                        <?= form_open('settings/'.$type.'/delete/' . $item->id) ?> <button type="submit" class="btn btn-danger mb-3 mx-2">حذف</button><?= form_close() ?>

                        <?= form_open('settings/'.$type.'/edit/' . $item->id) ?> <button type="submit" class="btn btn-primary mb-3 mx-2">تعديل</button><?= form_close() ?>
                    </div>
                </td>
